...
/*				0.183103168997d-044 iterations*/
  ...
  c_print_results("MG",Class,nx[lt],ny[lt],nz[lt],nit,nthreads,t,mflops,"          floating point",verified,"2.3","09 Feb 2015","identityTranslator","$(CC)","(none)","-I../common","-g","-lm","randdp");
}
/*--------------------------------------------------------------------
c-------------------------------------------------------------------*/
