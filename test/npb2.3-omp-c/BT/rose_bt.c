...
//if ( tmax != 0.0 ) {
  ...
  c_print_results("BT",cclass,grid_points[0],grid_points[1],grid_points[2],niter,nthreads,tmax,mflops,"          floating point",verified,"2.3","09 Feb 2015","identityTranslator","$(CC)","(none)","-I../common","-g","-lm","(none)");
}
/*--------------------------------------------------------------------
c-------------------------------------------------------------------*/
