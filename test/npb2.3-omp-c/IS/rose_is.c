...
INT_TYPE key_buff1[1 << 27];
INT_TYPE key_buff2[1 << 27];
...
/*  The final printout  */
  if (passed_verification != 5 * 10 + 1) 
    passed_verification = 0;
  c_print_results("IS",'C',1 << 27,0,0,10,nthreads,timecounter,((double )(10 * (1 << 27))) / timecounter / 1000000.,"keys ranked",passed_verification,"2.3","09 Feb 2015","identityTranslator","$(CC)","(none)","-I../common","-g","-lm","randlc2");
  return 0;
/**************************/
/*  E N D  P R O G R A M  */
}
