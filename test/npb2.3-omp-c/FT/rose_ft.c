...
/* end parallel */
  ...
  c_print_results("FT",cclass,512,256,256,niter,nthreads,total_time,mflops,"          floating point",verified,"2.3","09 Feb 2015","identityTranslator","$(CC)","(none)","-I../common","-g","-lm","randdp");
  if (0 == 1) 
    print_timers();
}
/*--------------------------------------------------------------------
